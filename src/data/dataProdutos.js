...
export const listaDetalhesSpeakers = [
  {
    id: 1,
    imagemPrincipal: "https://www.dropbox.com/scl/fi/76nyytrnqxm22ks28b5qu/image-product.jpg?rlkey=fad6cduy1o4njxtqr6x8rp6vs&raw=1",
    descricao: "ZX9 SPEAKER",
    sobre: "Upgrade your sound system with the all new ZX9 active speaker. It’s a bookshelf speaker system that offers truly wireless connectivity -- creating new possibilities for more pleasing and practical audio setups.",
    preco: "4.500",
  ...
  {
    id: 2,
    imagemPrincipal: "https://www.dropbox.com/scl/fi/x832vwrxcuwr82kxy312f/image-product.jpg?rlkey=9p21b9xa17grf6eiyer6gj0s2&raw=1",
    descricao: "ZX7 SPEAKER",
    sobre: "Stream high quality sound wirelessly with minimal to no loss. The ZX7 speaker uses high-end audiophile components that represents the top of the line powered speakers for home or studio use.",
    preco: "3.500",
...
export const listaDetalhesEarPhones = [
  {
    id: 1,
    imagemPrincipal: "https://www.dropbox.com/scl/fi/4tfcerwxb60mf4d8l7zwc/image-product.jpg?rlkey=toi5wc8hdww7yespono39rc5g&raw=1",
    descricao: "YX1 WIRELESS EARPHONES",
    sobre: "Tailor your listening experience with bespoke dynamic drivers from the new YX1 Wireless Earphones. Enjoy incredible high-fidelity sound even in noisy environments with its active noise cancellation feature.",
    preco: "599",
